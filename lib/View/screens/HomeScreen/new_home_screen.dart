...
class _ThreeStepFormState extends State<ThreeStepForm> {
  ...
  RxString selectBloodGroup = "O+".obs;
  RxString selectReligon = "Hindu".obs;
  RxString selectCaste = "Gen".obs;
  RxString selectYearOfPassing = "2025".obs;
                ...
                if (_currentStep != 0)
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor:
                          Colors.white, // You can set different color for Back
                    ),
                    child: Text(
                      'Previous',
                      style: GoogleFonts.poppins(
      ...
      children: [
        ...
        Obx(
          () => CustomWidgets.customDropdownField(
            ...
            selectedItem: selectBloodGroup.value,
            onChanged: (value) {
              if (value != null) {
        ...
        Obx(() {
          ...
          return Visibility(
            visible: selectReligon.value == "Hindu",
            child: CustomWidgets.customDropdownField(
              context: context,
        ...
        CustomWidgets.customTextFeild(
          ...
          validate: (value) {
            if (value == null || value.isEmpty) {
              return 'Please enter Board/University';
            }
            return null;
          },
          // focusNode: FocusNode(),
